    ...
    try:
        ...
        try:
            ...
            if predicted_class_index in available_labels:
                ...
                print(
                    f"Warning: Using label {label_to_explain} instead of predicted class {predicted_class_index}")
            else:
            ...
            explanation_path = os.path.join(
                EXPLANATION_FOLDER, explanation_filename)
            ...
            response["explanation_url"] = url_for(
                "static", filename=f"explanations/{explanation_filename}")
